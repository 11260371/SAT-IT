...
parser.add_argument('--model', default='./checkpoints/fat_cifar10',
...
def main():
    ...
    # Set > 0 to resume from model_dir/model-res-epoch{N}.pt
    # Set > 0 to resume from model_dir/model-res-epoch{N}.pt
    checkpoint_epoch = 0
    ...
    for epoch in range(start_epoch, args.epochs + 1):
        ...
        epoch_loss = train(args, model, device, train_loader, optimizer, epoch)
